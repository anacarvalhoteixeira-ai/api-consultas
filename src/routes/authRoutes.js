...
import { criarUsuario, listarUsuarios, login, register } from '../controllers/authController.js';
...
router.get('/usuarios', authMiddleware, autorizarCargos('ADMIN'), listarUsuarios);
